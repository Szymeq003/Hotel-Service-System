                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p><a href="{{ route('room',['id'=>$room->id]) }}" class="btn btn-primary" role="button">Szczegóły</a><a href="{{ route('room',['id'=>$room->id]) }}#reservation" class="btn btn-success pull-right" role="button">Zarezerwuj</a></p>
                        </div>
                    </div>
                </div>
